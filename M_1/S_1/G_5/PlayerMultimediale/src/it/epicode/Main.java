...
public class Main {
    ...
    * 2.1
    * SE L'OGGETTO SCELTO NON è PRESENTE RESITUIRE UN MESSAGGIO CHE INCORAGGIA A CREARE DEGLI OGGETTI
    * 2.2
    * SE L'OGGETTO E PRESENTE MOSTRARLO E DARE LA POSSIBILITA DI USCIRE
    * MOSTRARE L'OGGETTO SIGNIFICA MOSTRARE I SUOI ATTRIBUTI
    *
